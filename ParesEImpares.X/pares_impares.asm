...
; CUERPO DE PROGRAMA
		...
		movlw	0x02
		movwf	TRISA
		;MUEVE LA CONSTANTE "02" HACÍA W, ENSEGUIDA, LO MUEVE A TRISA
		movlw	0x00
		movwf	TRISB
		;MUEVE LA CONSTANTE "00" HACÍA W, ENSEGUIDA, LO MUEVE A TRISB
		
	INICIO	btfss    PORTA,1
		bra	PARES
		bra	IMPARES		
		;COMPRUEBA QUE EN EL PIN1 (RA1) HAYA 1
		; SI LO HAY, PASA A "IMPARES", SINO PASA A "PARES"
		 
	IMPARES	    movlw   0x55
		    movwf   PORTB
		    bra	    INICIO
		    ;MUEVE LA CONSTANTE "55" A W Y DE W A "PORTB" (IMPRIME LOS NÚMEROS IMPARES)
		    ;FINALMENTE REGRESA A LA COMPROBACION "INICIO"
	PARES	    movlw   0xAA
		    movwf   PORTB
		    bra	    INICIO
		    ;MUEVE LA CONSTANTE "AA" A W Y DE W A "PORTB" (IMPRIME LOS NÚMEROS PARES)
		    ;FINALMENTE REGRESA A LA COMPROBACION "INICIO"
		    END