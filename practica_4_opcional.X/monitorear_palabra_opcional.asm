...
; CUERPO DE PROGRAMA
		REGISTRO_1	EQU	    0x0f
		; REGISTRO_1 = dirección de memoria 0x0F
		MOVLW		0x0f
		MOVWF		TRISA
		;PRIMEROS 4 BITS SON DE ENTRADA
		MOVLW		0x00
		MOVWF		TRISB
		;LOS BITS SON SALIDAS
		
		MOVLW		0x0D
		MOVWF		REGISTRO_1
		;SE MUEVE LA CONSTANTE QUE QUIERO VERIFICAR A "REGISTRO_1"
		MOVF		PORTA,0; MUEVO LO QUE LLEGUE DE "PORTA" AL REGISTRO DE TRABAJO
		
	INICIO	XORWF		REGISTRO_1,1
		;SE REALIZA LA OPERACIÓN 'XOR' Y SÓLO DARÁ CERO CUANDO LAS DOS
		;COMBINACIONES SEAN IGUALES
		TSTFSZ		REGISTRO_1
		BRA		IMPRIME_04
		BRA		IMPRIME_02
		;COMPRUEBA QUE "REGISTRO_1" SEA CERO, SI LO ES,
		;ENTONCES QUIERE DECIR QUE LA CONTRASEÑA ES CORRECTA Y SALTA LÍNEA,
		;SI NO, ENTONCES IMPRIME LA CONSTANTE "0x04"
	IMPRIME_04
		MOVLW		0x04
		MOVWF		PORTB ;CONTRASEÑA INCORRECTA
		BRA		INICIO		
	IMPRIME_02
		MOVLW		0x02
		MOVWF		PORTB ;CONTRASEÑA CORRECTA
		BRA		INICIO
		END