...
; CUERPO DE PROGRAMA
		...
		MOVLW	0x0f
		MOVWF	TRISA  ;PINES DE ENTRADA EN EL PUERTO A
		
		MOVLW	0x00
		MOVWF	TRISB	;PINES DE SALIDA EN EL PUERTO B
		
	INICIO	MOVF	PORTA,0	    ;LO DEL PUERTO A SE MUEVE A "W"
		ANDLW	b'00001110' ;ENMASCARAR DIRECCIONES
		
		CALL	TABLA ;SE VA A LA SUBRUTINA "TABLA"
		MOVWF	PORTB ; MUEVE LO QUE REGRESA LA SUBRUTINA ANTERIOR Y LO ENTREGA EN EL PUERTO B
	...
	TABLA	ADDWF	PCL, 1
		...
		RETLW	0x73;P
		RETLW	0x54;N
		;ESTA TABLA LO QUE HACE ES RETORNARNOS EL NÚMERO DE ACUERDO A LO QUE HAYA
		;EN EL "PCL"
		END 
