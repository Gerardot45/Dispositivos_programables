...
; CUERPO DE PROGRAMA
		...
		movlw	0x02 ;MUEVE LA CONSTANTE "02" PARA QUE EL PUERTO RA0 SEA UNA ENTRADA
		movwf	TRISA 
		movlw	0x00 ; MUEVE LA CONSTANTE "00" PARA QUE TODOS LOS PUERTOS SEAN SALIDAS
		movwf	TRISB
		
	INICIO	btfss    PORTA,1 
		;COMPRUEBA SI EN RA0 HAY UN BIT, SI LO HAY, SALTA UNA LINEA (ALARMA), SINO, VA HACÍA "NO_ALARMA" 
		bra	NO_ALARMA
		bra	ALARMA
		 
	NO_ALARMA   movlw   0x40
		    movwf   PORTB ;MUEVE LA CONSTANTE "0X40" A PORTB
